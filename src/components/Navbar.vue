    ...
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
        <div class="container flex flex-wrap justify-between items-center mx-auto" bis_skin_checked="1">
            <a href="/" class="flex items-center">
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Pinia</span>
            </a>
            <div class="flex md:order-2" bis_skin_checked="1">
                ...
                <div class="hidden relative md:block" bis_skin_checked="1">
                    ...
                    <input type="text" id="search-navbar" v-model="moviesStore.query"
                ...
                <ul
                    ...
                    <li>
                        <router-link :to="{ name: 'Home' }"
                            ...
                            active-class="text-blue-500 dark:text-blue-500" aria-current="page">Home</router-link>
                    </li>
                    <li>
                        <router-link :to="{ name: 'About' }"
                            class="block py-2 pr-4 pl-3 text-slate-700 rounded md:bg-transparent md:p-0 dark:text-white"
                            active-class="text-blue-500 dark:text-blue-500" aria-current="page">About</router-link>
                    </li>
                    <li>
                        <router-link :to="{ name: 'MovieList' }"
                            class="block py-2 pr-4 pl-3 text-slate-700 rounded md:bg-transparent md:p-0 dark:text-white"
                            active-class="text-blue-500 dark:text-blue-500" aria-current="page">Movies</router-link>
                    </li>
                </ul>
            </div>
        </div>
